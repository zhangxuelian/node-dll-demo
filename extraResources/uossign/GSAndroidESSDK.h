...
* @return	成功返回0,失败返回>0.
*/
ADNDROIDESS_API int ADESS_SDK_Init(char* szCameraSdkPath = (char*)"");
...
* @return	成功返回0,失败返回>0.
*/
ADNDROIDESS_API int ADESS_SDK_SetTime(ADESSHandle handle, unsigned long long lCurrentTime = 0);
